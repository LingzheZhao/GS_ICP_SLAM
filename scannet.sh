...
run_scannet()
{
    ...
    run_ "scene0059_00" "configs/Scannet/scene0059_00.txt" $result_txt $keyframe_th $knn_maxd $overlapped_th $max_correspondence_distance $trackable_opacity_th $overlapped_th2 $downsample_rate
    run_ "scene0106_00" "configs/Scannet/scene0106_00.txt" $result_txt $keyframe_th $knn_maxd $overlapped_th $max_correspondence_distance $trackable_opacity_th $overlapped_th2 $downsample_rate
    run_ "scene0169_00" "configs/Scannet/scene0169_00.txt" $result_txt $keyframe_th $knn_maxd $overlapped_th $max_correspondence_distance $trackable_opacity_th $overlapped_th2 $downsample_rate
}
