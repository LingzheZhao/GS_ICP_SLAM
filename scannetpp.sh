...
run_scannetpp()
{
    ...
    run_ "8b5caf3398" "TBA" $result_txt $keyframe_th $knn_maxd $overlapped_th $max_correspondence_distance $trackable_opacity_th $overlapped_th2 $downsample_rate
    run_ "b20a261fdf" "TBA" $result_txt $keyframe_th $knn_maxd $overlapped_th $max_correspondence_distance $trackable_opacity_th $overlapped_th2 $downsample_rate
}
...
run_scannetpp $txt_file $keyframe_th $knn_maxd $overlapped_th $max_correspondence_distance \
